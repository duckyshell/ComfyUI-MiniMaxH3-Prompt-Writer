...
function renderOllamaProviderControl() {
  ...
  return `${header}${ollamaJourneyMarkup("ready")}<div class="h3ps-ollama-ready">
    ...
    <div class="h3ps-ollama-model-heading"><span>Prompt model</span></div>
    ...
    <button class="h3ps-ollama-add-model-toggle" type="button" data-ollama-add-model aria-expanded="${String(addModelOpen)}">${icon("plus", 12)} ${addModelOpen ? "Hide model options" : "Install another model"}</button>
