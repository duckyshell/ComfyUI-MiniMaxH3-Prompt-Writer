      ...
      <div class="h3ps-settings-content">
        ...
        <section class="h3ps-settings-card h3ps-runtime-settings">
          ...
          <div class="h3ps-runtime-settings-grid">
            <label><span>Context</span><button type="button" data-runtime-toggle="context"><b data-runtime-label="context">Auto</b>${icon("chevron", 12)}</button><span class="h3ps-runtime-menu" data-runtime-menu="context" hidden><button type="button" data-runtime-option="context" data-value="auto">Auto</button><button type="button" data-runtime-option="context" data-value="low">8K</button><button type="button" data-runtime-option="context" data-value="standard">16K</button><button type="button" data-runtime-option="context" data-value="extended">24K</button><button type="button" data-runtime-option="context" data-value="large">32K</button><button type="button" data-runtime-option="context" data-value="maximum">48K</button><button type="button" data-runtime-option="context" data-value="custom">Custom</button></span></label>
          ...
          <label class="h3ps-runtime-custom" data-custom-context hidden><span>Custom Context</span><input type="number" min="1024" step="1" inputmode="numeric" placeholder="Tokens" data-custom-context-input></label>
          <details class="h3ps-direct-advanced" data-direct-runtime-advanced>
            <summary><span>Advanced</span><small>Auto keeps model defaults</small>${icon("chevron", 12)}</summary>
            <div class="h3ps-runtime-settings-grid">
              <label><span>Generation budget</span><button type="button" data-runtime-toggle="budget"><b data-runtime-label="budget">Auto</b>${icon("chevron", 12)}</button><span class="h3ps-runtime-menu" data-runtime-menu="budget" hidden><button type="button" data-runtime-option="budget" data-value="auto">Auto</button><button type="button" data-runtime-option="budget" data-value="2048">2,048</button><button type="button" data-runtime-option="budget" data-value="4096">4,096</button><button type="button" data-runtime-option="budget" data-value="8192">8,192</button><button type="button" data-runtime-option="budget" data-value="custom">Custom</button></span></label>
              <label data-reasoning-effort-control hidden><span>Reasoning effort</span><button type="button" data-runtime-toggle="reasoning"><b data-runtime-label="reasoning">Auto</b>${icon("chevron", 12)}</button><span class="h3ps-runtime-menu" data-runtime-menu="reasoning" hidden></span></label>
            </div>
            <label class="h3ps-runtime-custom" data-custom-generation-budget hidden><span>Custom Generation budget</span><input type="number" min="1" step="1" inputmode="numeric" placeholder="Tokens" data-custom-generation-budget-input></label>
          </details>
